...
The Gold Layer represents the business-level data model designed to support analytical and reporting use cases. It consists of dimension tables and fact tables structured for specific business metrics, following a dimensional modeling approach.
