...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Truncating Tabble Silver: silver.crm_info';
		TRUNCATE TABLE silver.crm_cust_info;
		PRINT '>> Inserting Data Info: silver.crm_info';
		...
		*, ROW_NUMBER() OVER(PARTITION BY cst_id ORDER BY cst_create_date  DESC) AS flag_last
		...
		SET @start_time=GETDATE()
		PRINT '>> Truncating Tabble Silver: silver.crm_prd_info';
		...
		SET @start_time=GETDATE()
		PRINT '>> Truncating Tabble Silver: silver.crm_sales_details';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tabble Silver: silver.erp_px_cat_g1v2';
		...
		SET @start_time = GETDATE();
		PRINT '>> Truncating Tabble Silver: silver.erp_loc_a101';
